...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        /// <summary>
        /// 自定义一个search，从数据库中取得最近的一条order记录
        /// </summary>
        /// <param name="order"></param>
        //public virtual Order findOrder(string OrderGuid)
        //{
        //    if (OrderGuid == null)
        //        throw new ArgumentNullException("OrderGuid");
        //    var query = _orderRepository.Table;
        ...
        //public virtual void UpdateOrderPMS(string paymentMethodSystemName)
        //{
        //    if (String.IsNullOrEmpty(paymentMethodSystemName))
        //    {
        //        throw new ArgumentNullException("paymentMethodSystemName");
        //    }
